...
from app.api.routes import health_router, products_router, content_library_router, drafts_router, post_history_router, posting_router, schedules_router, automation_rules_router, automation_runner_router, test_scheduled_posting_router, auth_facebook_lite_router, auth_router, pages_router, settings_router, creative_router
from app.core.database import ensure_automation_rules_columns, ensure_demo_user, ensure_drafts_page_id_nullable, ensure_facebook_pages_selected_column, ensure_user_auth_columns
