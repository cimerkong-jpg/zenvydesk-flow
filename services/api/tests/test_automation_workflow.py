...
def test_automation_auto_post_creates_post_history(client, test_db, test_user, auth_headers, test_page, test_product):
    rule = create_automation_rule(
        test_db,
        user_id=test_user.id,
        page_id=test_page.id,
...
def test_automation_uses_fallback_when_provider_missing_key(client, test_db, test_user, auth_headers, test_page, test_product):
    rule = create_automation_rule(
        test_db,
        user_id=test_user.id,
        page_id=test_page.id,
